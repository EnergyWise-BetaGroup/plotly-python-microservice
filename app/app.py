...
#     print(new_df)
    ...
    # return jsonify({'visualisation_html': new_df })
...
def generate_style_visualisation():
    ...
    print("df_meter")
    print(df_meter)
    # Convert the intensity data to a DataFrame
    ...
    # Convert the 'start_datetime' to datetime format
